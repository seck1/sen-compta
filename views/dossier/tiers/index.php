...
.tiers-nom { font-size:13px; font-weight:700; color:var(--navy-dark); margin-bottom:8px; }
.tiers-info { font-size:14px; color:var(--text-muted); display:flex; flex-direction:column; gap:3px; }
...
.empty-tiers h3 { font-size:14px; font-weight:600; color:var(--navy-dark); margin-bottom:6px; }
.empty-tiers p  { font-size:14px; color:var(--text-muted); }
</style>
...
<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:20px">
    <div class="card" style="display:flex;align-items:center;gap:14px;padding:16px 20px">
        ...
        <div>
            ...
            <div style="font-size:13px;color:var(--text-muted);text-transform:uppercase;letter-spacing:.8px">Fournisseurs</div>
        </div>
    </div>
    <div class="card" style="display:flex;align-items:center;gap:14px;padding:16px 20px">
        ...
        <div>
            ...
            <div style="font-size:13px;color:var(--text-muted);text-transform:uppercase;letter-spacing:.8px">Clients</div>
        </div>
    </div>
    <div class="card" style="display:flex;align-items:center;gap:14px;padding:16px 20px">
        ...
        <div>
            ...
            <div style="font-size:13px;color:var(--text-muted);text-transform:uppercase;letter-spacing:.8px">Total tiers</div>
        </div>
    </div>
</div>
...
<form method="GET" action="">
    ...
    <div class="filter-bar">
        ...
        <?php if ($filtre_q): ?>
        <a href="<?= APP_URL ?>/dossier/tiers?id=<?= $entreprise['id'] ?>" style="font-size:14px;color:var(--text-muted);text-decoration:none;display:inline-flex;align-items:center;gap:4px"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" style="width:14px;height:14px"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/></svg> Effacer</a>
        <?php endif; ?>
    </div>
</form>
