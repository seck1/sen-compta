...
<div style="max-width:1000px">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:20px">
        <div class="card" style="padding:16px 20px">
            ...
            <div style="font-family:monospace;font-size:13px;font-weight:700;color:#dc2626"><?= formatMontant($total_debit) ?></div>
        </div>
        <div class="card" style="padding:16px 20px">
            ...
            <div style="font-family:monospace;font-size:13px;font-weight:700;color:#1f6e4e"><?= formatMontant($total_credit) ?></div>
        </div>
        <div class="card" style="padding:16px 20px">
            ...
            <div style="font-family:monospace;font-size:13px;font-weight:700;color:<?= $total_solde > 0 ? '#dc2626' : ($total_solde < 0 ? '#1f6e4e' : 'var(--text-muted)') ?>">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:14px">
            <thead>
                <tr style="border-bottom:2px solid var(--border);background:var(--bg-secondary)">
                    <th style="padding:11px 16px;text-align:left;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;background:#f1f5f9;color:#4a554f">Tiers</th>
                    <th style="padding:11px 16px;text-align:right;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;background:#f1f5f9;color:#4a554f">Débit</th>
                    <th style="padding:11px 16px;text-align:right;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;background:#f1f5f9;color:#4a554f">Crédit</th>
                    <th style="padding:11px 16px;text-align:right;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;background:#f1f5f9;color:#4a554f">Solde débiteur</th>
                    <th style="padding:11px 16px;text-align:right;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;background:#f1f5f9;color:#4a554f">Solde créditeur</th>
                    <th style="padding:11px 16px;text-align:center;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;background:#f1f5f9;color:#4a554f">Détail</th>
                </tr>
            </thead>
            <tbody>
            ...
            <tfoot>
                <tr style="border-top:2px solid var(--border);background:var(--bg-secondary)">
                    <td style="padding:11px 16px;font-weight:700;font-size:14px">TOTAL</td>
