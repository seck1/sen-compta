...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <a href="<?= APP_URL ?>/superadmin/online" class="nav-item <?= ($activePage ?? '') === 'superadmin-online' ? 'active' : '' ?>">
        ...
        <div class="nav-section">
            ...
            <a href="<?= APP_URL ?>/commercial/avoirs" class="nav-item <?= str_starts_with($activePage ?? '', 'commercial-avoirs') ? 'active' : '' ?>">
                <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 14l6-6M9 8h.01M15 14h.01M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z"/></svg>
                Avoirs
            </a>
