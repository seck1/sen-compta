    ...
    public function storeBulletin(): void {
        ...
        $stmt = $db->prepare("INSERT INTO bulletins_paie
            (entreprise_id, employe_id, user_id, periode_mois, periode_annee,
             ...
             avantages_nature, transport_exonere, brut_imposable,
             ipres_salarie, trimf, ir_salarie, ipm_salarie,
             total_retenues, acompte, retenues_diverses, net_a_payer,
            ...
            ON DUPLICATE KEY UPDATE
             ...
             avantages_nature=VALUES(avantages_nature), transport_exonere=VALUES(transport_exonere),
             brut_imposable=VALUES(brut_imposable),
             ipres_salarie=VALUES(ipres_salarie), trimf=VALUES(trimf),
             ir_salarie=VALUES(ir_salarie), ipm_salarie=VALUES(ipm_salarie),
             total_retenues=VALUES(total_retenues),
             acompte=VALUES(acompte), retenues_diverses=VALUES(retenues_diverses),
        ...
        $stmt->execute([
            ...
            $bulletin['transport_exonere'],
            $bulletin['brut_imposable'],
